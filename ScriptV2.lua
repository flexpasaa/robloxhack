...
local function UpdateSystemColor(newColor)
    ...
    for _, label in ipairs(UI_Elements.SectionLabels) do label.TextColor3 = newColor end
    ...
    for _, slider in ipairs(UI_Elements.Sliders) do slider.Fill.BackgroundColor3 = newColor end
end

local ScreenGui = Instance.new("ScreenGui")
local coreGuiSuccess, _ = pcall(function() ScreenGui.Parent = game:GetService("CoreGui") end)
if not coreGuiSuccess or not ScreenGui.Parent then ScreenGui.Parent = LocalPlayer:WaitForChild("PlayerGui", 10) end
...
RunService:BindToRenderStep("Flex_Core_Engine", 2000, function()
    ...
    if Config.MenuOpen then
        ...
        UserInputService.MouseIconEnabled = not isActualFirstPerson
    end
end)
